...
const Icon = () => {
    return (
        <div className="absolute z-40 top-[40%] flex justify-center items-center gap-8 md:flex-col md:items-start md:pl-[8%] md:top-[30%] md:gap-8">
            <Image
            ...
            />
            <h3
                className="text-white font-bold w-1/2 text-center md:text-xl lg:text-2xl -ml-7 glowing-text"
            >
